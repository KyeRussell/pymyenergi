...
def zappi_fetch_data_fixture():
    """Mock data from client.fetch_data()"""
    with patch("pymyenergi.zappi.Zappi.fetch_data", return_value=load_fixture_json("zappi")):
        yield
...
def eddi_fetch_data_fixture():
    """Mock data from client.fetch_data()"""
    with patch("pymyenergi.eddi.Eddi.fetch_data", return_value=load_fixture_json("eddi")):
        yield
...
def harvi_fetch_data_fixture():
    """Mock data from client.fetch_data()"""
    with patch("pymyenergi.harvi.Harvi.fetch_data", return_value=load_fixture_json("harvi")):
        yield
...
def libbi_fetch_data_fixture():
    """Mock data from client.fetch_data()"""
    with patch("pymyenergi.libbi.Libbi.fetch_data", return_value=load_fixture_json("libbi")):
        yield
